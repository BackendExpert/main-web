            ...
            <div className="">
                ...
                <ul className={`md:flex md:items-center absolute md:static md:pb-0 pb-10 md:bg-[#293352] bg-gray-800 md:mt-0 mt-[-15px] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${menuOpen ? 'top-20' : 'top-[-500px]'}`}>
                    ...
                    <li className="px-4 mr-12 md:py-0 pt-4 pb-4">
                        ...
                        <div className={`md:pr-8 pt-6 -ml-5 md:pl-8 md:pt-8 md:pb-8 rounded md:ml-[8%] md:w-5/6 md:mt-10 bg-gray-800 md:items-center md:pb-0 md:absolute md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9  ${aboutOpen ? 'static' : 'hidden'}`}>
                    ...
                    <li className="px-4 mr-20 md:py-0 pt-6 pb-6">
                        ...
                        <div className={`md:pr-8 pt-6 -ml-5 md:pl-8 md:pt-8 md:pb-8 rounded md:ml-[8%] md:w-5/6 md:mt-10 bg-gray-800 md:items-center md:pb-0 md:absolute md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9  ${oepnAcad ? 'static' : 'hidden'}`}>
